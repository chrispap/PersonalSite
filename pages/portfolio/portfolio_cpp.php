...
<div class="entry">
    ...
    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>BVL_3.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
...
<div class="entry">
    ...
    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>Subtitles.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
