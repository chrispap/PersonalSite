<h1> <div class="title">
        <a href="<?php echo $PATH;?>portfolio/java" > Java </a>
</div></h1>

<div class="entry">
    <div class="title"><i>SUDOKU SOLVER</i>:</div>

    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>sudoku-screenshot.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
...
<div class="entry">
    ...
    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>BoolSim-screenshot.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
...
<div class="entry">
    ...
    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>synergeio-screenshot.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
...
<div class="entry">
    ...
    <div class="links">
        <img src="<?php echo $this->IMAGE_PATH; ?>gameoflife-screenshot.png" border="0" onclick="showImage(this.src);" > <br/>
        <ul>
